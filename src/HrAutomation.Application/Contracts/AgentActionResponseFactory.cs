...
public static class AgentActionResponseFactory
{
        ...
        ActorType actorType = ActorType.agent)
    {
        return new AgentActionResponse
        {
            ...
            InterviewRoundId = skillResult.InterviewRoundId,
            OfferId = skillResult.OfferId,
            GreenFormSubmissionId = skillResult.GreenFormSubmissionId,
            EmployeeId = skillResult.EmployeeId,
            EmployeeNumber = skillResult.EmployeeNumber,
