...
| 1.1 | 2026-09-09 | Platform upgrade — Phase 2/3 (Claude Code) | Updated stated runtime baseline from .NET 8/Node 20+ to .NET 10/Node 24+ to match the real implementation after the platform upgrade; see [platform-upgrade-gap-analysis.md](../09-quality-evaluation/platform-upgrade-gap-analysis.md) |
